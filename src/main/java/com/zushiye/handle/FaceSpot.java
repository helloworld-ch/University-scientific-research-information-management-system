...
//    private static final BASE64Decoder decoder = new BASE64Decoder();
    //需要修改为自己的
    private static final String AppID = "26375799";
    private static final String APIKey = "isSpyxb3RXiK6pHSprBeG2ZR";
    private static final String SecretKey = "eLVGK4fG9jORpZY3TqSXAXqkvWbzoO5U";
...
//        BASE64Decoder decoder = new BASE64Decoder();
        String file1 = "D:\\MobileFile\\IMG_20220605_150036.jpg";
        byte[] img2 = FileToByte(new File(file1));
        System.out.println(searchFace(img2, "face","admin"));
    }
